...
<div class="container" style="justify-content: center">
    <div class="box">
        ...
        <div class="content">
            Kính gửi khách hàng,
            <br>
            Để tăng cường bảo mật tài khoản của bạn, vui lòng nhấp vào nút bên dưới để hoàn tất đổi mật khẩu trong vòng
            30 phút
            tới.
            <br>
            <a class="btn_link" href="{{$mailData['url']}}" target="_blank">
                Đổi mật khẩu
            </a>
